...
DeenQuest/
├── day-1/
│   ├── readme.md        # Bangla version (auto-renders on GitHub)
│   ├── readme_en.md     # English version
│   └── index.html       # Interactive HTML version (optional enhancement)
├── day-2/
├── ...
```
...
### Audio Sources (free):
- Quran: [Quranicaudio.com](https://www.quranicaudio.com)
- Duas: [Basira.co.uk](https://www.basira.co.uk/duas/)
